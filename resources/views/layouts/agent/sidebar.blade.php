        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ str_contains(request()->url(), 'agent/dashboard') == true ? 'active' : '' }}" href="{{route('agent.dashboard')}}">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ str_contains(request()->url(), 'agent/application/') == true ? 'active' : '' }}" href="{{route('agent.application.list')}}">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-user fs-2">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ str_contains(request()->url(), 'agent/invoices') == true ? 'active' : '' }}" href="{{route('agent.invoices')}}">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-user fs-2">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ str_contains(request()->url(), 'agent/followups') == true ? 'active' : '' }}" href="{{route('agent.followups')}}">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-user fs-2">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ str_contains(request()->url(), 'agent/documents') == true ? 'active' : '' }}" href="{{route('agent.documents')}}">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-user fs-2">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                    ...
                    <div class="menu-item pt-5">
                     ...
                     <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ str_contains(request()->url(), 'admin/account') == true ? 'here show' : '' }}">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            <div class="menu-item">
                                <a class="menu-link {{ Route::is('agent.account.overview') == true ? 'active' : '' }}" href="{{ route('agent.account.overview') }}">
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Route::is('agent.account.setting') == true ? 'active' : '' }}" href="{{ route('agent.account.setting') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Route::is('agent.account.activity') == true ? 'active' : '' }}" href="{{ route('agent.account.activity') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
