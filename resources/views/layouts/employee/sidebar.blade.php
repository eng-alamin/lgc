        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper">
            ...
            <div id="kt_app_sidebar_menu_scroll" class="scroll-y my-5 mx-3" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
                ...
                <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ str_contains(request()->url(), 'employee/dashboard') == true ? 'active' : '' }}" href="{{route('employee.dashboard')}}">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Route::is('employee.attendances') == true ? 'active' : '' }}" href="{{ route('employee.attendances') }}">
                            <span class="menu-icon">
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Route::is('employee.leaves') == true ? 'active' : '' }}" href="{{ route('employee.leaves') }}">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-menu fs-2">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ Route::is('employee.payrolls') == true ? 'active' : '' }}" href="{{ route('employee.payrolls') }}">
                            <span class="menu-icon">
                                <i class="ki-duotone ki-menu fs-2">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ str_contains(request()->url(), 'employee/account') == true ? 'here show' : '' }}">
                        <span class="menu-link {{ str_contains(request()->url(), 'employee/account') == true ? 'active' : '' }}">
                            <span class="menu-icon">
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            <div class="menu-item">
                                <a class="menu-link {{ Route::is('employee.account.overview') == true ? 'active' : '' }}" href="{{ route('employee.account.overview') }}">
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Route::is('employee.account.setting') == true ? 'active' : '' }}" href="{{ route('employee.account.setting') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                            ...
                            <div class="menu-item">
                                <a class="menu-link {{ Route::is('employee.account.activity') == true ? 'active' : '' }}" href="{{ route('employee.account.activity') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
