    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between" id="kt_app_header_container">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="../../demo1/dist/index.html" class="d-lg-none">
                <img alt="Logo" src="{{asset('assets/backend/media/logos/default-small.png')}}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
                ...
                <div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0" id="kt_app_header_menu" data-kt-menu="true">
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}" class="menu-item me-0 me-lg-2">
                        ...
                        <span class="menu-link">
                            <span class="menu-title"> <a href="{{ route('home') }}"> Home </a></span>
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        @if(auth()->user()->avatar)
                            <img src="{{asset(auth()->user()->avatar)}}" class="rounded-3" alt="{{auth()->user()->name}}" />
                        @else
                            <img src="{{asset('assets/backend/media/avatars/blank.png')}}" class="rounded-3" alt="user" />
                        @endif
                    </div>
