                        ...
                        <div class="sidenav">
                            <ul class="side_menu">
                                @foreach ($visas as $item)
                                    <li class="menu-item {{ str_contains(request()->url(), 'visa/detail/'.$item->id) ? 'active' : '' }}">
                                        <a href="{{ route('visa.detail', $item->id) }}" class="d-flex align-items-center justify-content-between">
                                            <span>
                                                {!! $item->icon !!}
                                                {{$item->title}}
                                            </span>
                    ...
                    <div class="blog-details-inner">
                        <div class="post-content">
                            <div class="post-header mt-0">
                                <h1 class="post-title">{{$visa->title}}</h1>
                            </div>
                            <div class="fulltext">
                                {!! $visa->description !!}
