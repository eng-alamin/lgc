<div>
    ...
    <section>
        <div class="container">
            @php $visa = $sections->where('type', 'visa')->first(); @endphp
            <div class="wptb-heading">
                <div class="wptb-item--inner text-center">
                    ...
                    <h1 class="wptb-item--title"> <span>{!! $visa->title !!}</span></h1>
                </div>
            </div>
                            ...
                            <div class="wptb-image-box3 wow fadeInLeft">
                                <div class="wptb-item--inner">
                                    <div class="wptb-item--image">
                                        ...
                                        <div class="wptb-item--button"> <a class="btn--readmore" href="{{ route('visa.detail', $item->id) }}"> <span class="btn-readmore--icon"> <i class="bi bi-arrow-right"></i> </span> </a></div>
                                    </div>
                                    <div class="wptb-item--holder">
                                        {{-- <div class="wptb-item--icon">
                                            <img src="{{asset('assets/frontend/assets/img/services/icon-8.png')}}" alt="icon">
                                            {!! $item->icon !!}
                                        </div> --}}
                                        <div class="wptb-item--wrap-content">
                                            <p class="wptb-item--description"> {{$item->title}}</p>
                                            <h4 class="wptb-item--title"><a href="{{ route('visa.detail', $item->id) }}">{{$item->subtitle}}</a></h4>
                                        </div>
                                    </div>
                                </div>
                            </div>
