...
<html lang="en">
	<head><base href="../../"/>
		<title>{{ config('setting.name') }} - Your account is approved</title>
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<div class="mb-14">
								<a href="{{'/'}}" class="">
									<img alt="Logo" src="{{asset(config('setting.logo'))}}" class="h-40px" />
								</a>
							</div>
							<!--end::Logo-->
							<!--begin::Title-->
							<h1 class="fw-bolder text-gray-900 mb-5">Please wait for some time for approval</h1>
							<!--end::Title-->
							<!--begin::Text-->
							...
							<!--begin::Link-->
							<div class="mb-11">
								<a href="{{'/'}}" class="btn btn-sm btn-primary">Go to Home Page</a>
							</div>
							<!--end::Link-->
							<!--begin::Illustration-->
							<div class="mb-0">
