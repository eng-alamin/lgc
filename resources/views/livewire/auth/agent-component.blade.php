            ...
            <div class="w-lg-500px p-10">
                ...
                <form wire:submit.prevent="store" class="form w-100" novalidate="novalidate" id="kt_sign_up_form">
                    ...
                    <div class="text-center mb-11">
                        <!--begin::Title-->
                        <h1 class="text-dark fw-bolder mb-3">Register for your business</h1>
                        <!--end::Title-->
                    </div>
                    <!--begin::Heading-->
                    <div class="fv-row mb-8">
                        <input type="text" placeholder="Business Name" wire:model="name" autocomplete="off" class="form-control bg-transparent" />
                        @error('name') <span class="form-text text-danger pt-2 pr-4">{{ $message }}</span> @enderror
                    </div>
                    <div class="fv-row mb-8">
                        <input type="text" placeholder="Business Email" wire:model="email" autocomplete="off" class="form-control bg-transparent" />
                        @error('email') <span class="form-text text-danger pt-2 pr-4">{{ $message }}</span> @enderror
                    </div>
                    <div class="fv-row mb-8">
                        <input type="text" placeholder="Business Phone" name="phone" wire:model.defer="phone" autocomplete="off" class="form-control bg-transparent" />
                    ...
                    <div class="fv-row mb-8">
                        <label class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" wire:model="type" />
                            <span class="form-check-label fw-semibold text-gray-700 fs-base ms-1">Agent Type - Individual
                            @error('type') <br> <span class="form-text text-danger pt-2 pr-4">{{ $message }}</span> @enderror
                        </label>
                    </div>
                    <!--end::Type-->
                    <!--begin::Accept-->
