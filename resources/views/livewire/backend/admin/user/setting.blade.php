@section('page-title') Setting @endsection
@section('breadcrumb')
        ...
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            ...
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <form role="form" method="POST" action="{{ route('admin.user.setting.update', $this->user->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="card-body border-top p-9">
                            ...
                            <div class="row mb-6">
                                ...
                                <div class="col-lg-8 fv-row">
                                    <input type="email" name="email" class="form-control form-control-lg form-control-solid" placeholder="Email number" value="{{$data->email}}" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="card-body border-top p-9">
                    ...
                    <div class="d-flex flex-wrap align-items-center d-none">
                        ...
                        <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                            <form class="form" method="POST" action="{{ route('agent.account.setting.email.update') }}" novalidate="novalidate">
                                @csrf
                                @method('PUT')
                    ...
                    <div class="d-flex flex-wrap align-items-center mb-10">
                        ...
                        <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                            <form method="POST" action="{{ route('admin.user.setting.password.update', $this->user->id) }}" class="form" novalidate="novalidate">
                                @csrf
                                @method('PUT')
                                    <div class="row mb-1">
                                        <div class="col-lg-4">
                                            <div class="fv-row mb-0">
                                                ...
                                                <input type="password" name="current_password" id="currentpassword" value="************" class="form-control form-control-lg form-control-solid" />
            ...
            @if($data->id > 1)
                <div class="card">
                    ...
                    <div id="kt_account_settings_deactivate" class="collapse show">
                            <form method="POST" action="{{ route('admin.user.setting.deactivate', $this->user->id) }}" class="form">
                                @csrf
                                {{-- @method('PUT') --}}
                                <div class="card-body border-top p-9">
                                    ...
                                    <div class="form-check form-check-solid fv-row">
                                        <input name="account_status" class="form-check-input" type="checkbox" @if($this->user->account_status == 1) value="2" @else value="1"  @endif id="status" @if($this->user->account_status == 2) checked @endif />
                                        <label class="form-check-label fw-semibold ps-2 fs-6" for="status">I confirm my account @if($this->user->account_status == 1) deactivation @else activation  @endif </label> <br>
                                        @error('account_status') <span class="text-danger">{{ $message }}</span> @enderror
                                    </div>
                                </div>
                                <div class="card-footer d-flex justify-content-end py-6 px-9">
                                    <button id="kt_account_deactivate_account_submit" type="submit" class="btn btn-danger fw-semibold">@if($this->user->account_status == 1) Deactivate @else Activate  @endif Account</button>
                                </div>
                            </form>
                    </div>
                    <!--end::Content-->
