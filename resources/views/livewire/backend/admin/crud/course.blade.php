                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7">
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-semibold mb-2">Rank</label>
                                    <input type="text" wire:model="number" name="number" class="form-control form-control-solid" placeholder="Enter Rank Number" />
