                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7">
                                <div class="fv-row mb-7">
                                    ...
                                    <textarea wire:model="question" name="question" cols="30" rows="10" class="form-control form-control-solid"></textarea>
                                    @error('question') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-semibold mb-2">Answer</label>
                                    <textarea wire:model="answer" name="answer" cols="30" rows="10" class="form-control form-control-solid"></textarea>
