                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Layer1</th>
                                <th class="min-w-125px">Layer2</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="symbol symbol-25px symbol-lg-50px symbol-fixed position-relative">
                                        <img src="{{asset($item->file1)}}" alt="Image">
                                    </div>
                                </td>
                                <td>
                                    <div class="symbol symbol-25px symbol-lg-50px symbol-fixed position-relative">
                                        <img src="{{asset($item->file2)}}" alt="layer 1">
                                    </div>
                                </td>
                                <td>
                                    <div class="symbol symbol-25px symbol-lg-50px symbol-fixed position-relative">
                                        <img src="{{asset($item->file3)}}" alt="Layer 2">
                                    </div>
                                </td>
                                <td>
                                    <div class="symbol symbol-25px symbol-lg-50px symbol-fixed position-relative">
                                        <img src="{{asset($item->file4)}}" alt="Layer 3">
                                    </div>
                                </td>
                                <td>{{$item->subtitle}}</td>
                                <td>{{$item->title}}</td>
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7">
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="file" wire:model="file1" name="file1" />
                                    @error('file') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold mb-2">Layer 1</label>
                                    <input type="file" wire:model="file2" name="file2" />
                                    @error('file2') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold mb-2">Layer 2</label>
                                    <input type="file" wire:model="file3" name="file3" />
                                    @error('file3') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold mb-2">Layer 3</label>
                                    <input type="file" wire:model="file4" name="file4" />
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" wire:model="link" name="link" class="form-control form-control-solid" placeholder="Enter Link" />
                            ...
                            <div class="scroll-y me-n7 pe-7">
                                <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src="{{asset($file1)}}" alt="file1">
                                    </div>
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold mb-2">New Image</label> <br>
                                    <input type="file" wire:model="newfile1" name="newfile1"/>
                                    @error('newfile1') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src="{{asset($file2)}}" alt="file2">
                                    </div>
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold mb-2">New Layer 1</label> <br>
                                    <input type="file" wire:model="newfile2" name="newfile2"/>
                                    @error('newfile2') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src="{{asset($file3)}}" alt="file3">
                                    </div>
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold mb-2">New Layer 2</label> <br>
                                    <input type="file" wire:model="newfile3" name="newfile3"/>
                                    @error('newfile3') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="me-7 mb-4">
                                    <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                        <img src="{{asset($file4)}}" alt="file4">
                                    </div>
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold mb-2">New Layer 3</label> <br>
                                    <input type="file" wire:model="newfile4" name="newfile4"/>
                                    @error('newfile4') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-semibold mb-2">Sub Title</label>
                                    <input type="text" wire:model="subtitle" name="subtitle" class="form-control form-control-solid" placeholder="Enter Sub Title" />
