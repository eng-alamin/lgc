                            ...
                            <div class="scroll-y me-n7 pe-7">
                                ...
                                <div class="fv-row mb-7">
                                 ...
                                 <div class="fv-row mb-7">
                                    ...
                                    <textarea wire:model="short_description" name="short_description" cols="30" rows="5" class="form-control form-control-solid"></textarea>
                    ...
                    <form class="form" role="form" wire:submit.prevent="update">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7">
                                ...
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-semibold mb-2">Short Description</label>
                                    <textarea wire:model="short_description" name="short_description" cols="30" rows="10" class="form-control form-control-solid"></textarea>
                                    @error('short_description') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-semibold mb-2">Description</label>
