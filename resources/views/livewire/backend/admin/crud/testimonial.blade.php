                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <textarea wire:model="comment" name="comment" cols="30" rows="10" class="form-control form-control-solid"></textarea>
                                    @error('comment') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-semibold mb-2">Review</label>
                                    <input type="text" wire:model="review" name="review" class="form-control form-control-solid" placeholder="Enter Review" />
