                ...
                <div class="modal-content">
                    <form class="form" role="form" wire:submit.prevent="store">
                        <div class="modal-header">
                            <h2 class="fw-bold">Add Province</h2>
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7">
                                ...
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-semibold mb-2">University</label>
                                    @foreach($names as $index => $name)
                                        <div class="flex mb-2">
                                            <input type="text" wire:model="names.{{ $index }}" placeholder="University name" class="p-2 bg-light w-50 rounded">
                                            <button type="button" wire:click="removeInput({{ $index }})" class="ml-2 p-2 text-light bg-danger border-0 rounded">Remove</button>
                                        </div>
                                    @endforeach
                                    <button type="button" wire:click="addInput()" class="mb-2 text-success p-2 bg-secondary border-0 rounded">Add More</button>
                                     @error('name') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                            </div>
                        </div>
