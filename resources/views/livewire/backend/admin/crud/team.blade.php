                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                        <thead>
                            <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                ...
                                <th class="min-w-125px">Social</th>
                        ...
                        <tbody class="fw-semibold text-gray-600">
                            ...
                            <tr>
                                ...
                                <td>{{$item->position}}</td>
                                <td>
                                    @foreach($item->social as $platform => $link)
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="text" wire:model="position" name="position" class="form-control form-control-solid" placeholder="Enter Position" />
                                    @error('position') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="required fs-6 fw-semibold mb-2">Social</label>
                                    <input type="text" wire:model="social.facebook" class="form-control form-control-solid mb-2" placeholder="Facebook">
                                    <input type="text" wire:model="social.instagram" class="form-control form-control-solid mb-2" placeholder="Instagram">
                                    <input type="text" wire:model="social.x" class="form-control form-control-solid mb-2" placeholder="X (Twitter)">
                                    <input type="text" wire:model="social.linkedin" class="form-control form-control-solid" placeholder="LinkedIn">
