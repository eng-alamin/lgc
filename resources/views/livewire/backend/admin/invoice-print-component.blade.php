...
<head>
  ...
  <!-- Site Title -->
  <title>Let's Go China Invoice</title>
  ...
  <style>
        ...
        .tm_invoice::before {
            ...
            width: 100%;
            height: 100%;
            background-image: url('{{asset("assets/print/img/logo.png")}}');
...
<body>
        ...
        <div class="tm_invoice_in">
          <div class="tm_invoice_head tm_top_head tm_mb20 tm_mb10_md">
            <div class="tm_invoice_left">
              <div class="tm_logo"><img src="{{asset('assets/print/img/logo.png')}}" alt="Logo"></div>
            </div>
              ...
              <div class="tm_grid_row tm_col_3">
                ...
                <div class="tm_text_center">
                  <p class="tm_accent_color tm_mb0">
                   ...
                   Moonlite Regency, Flat-5/A, House-2, Road-3,<br>
          ...
          <div class="tm_invoice_info tm_mb10">
            <div class="tm_invoice_info_left">
              ...
              <p>
                <b class="tm_f16 tm_primary_color">{{$invoice->form?->client?->name ?? 'Name:____'}}</b> <br>
                {{$invoice->form?->client?->data['address'] ?? 'Address:____'}} <br>
                {{$invoice->form?->client?->email ?? 'Email:____'}} <br>
                {{$invoice->form?->client?->phone ?? 'Phone:____'}}
              </p>
            </div>
            <div class="tm_invoice_info_right">
              ...
              <div class="tm_grid_row tm_col_3 tm_invoice_info_in tm_round_border tm_gray_bg">
                <div>
                  ...
                  <b class="tm_f18 tm_accent_color">#{{$invoice->number}}</b>
                </div>
                <div>
                  <span>Invoice Date:</span> <br>
                  <b class="tm_f18 tm_accent_color">{{$invoice->date}}</b>
                </div>
                <div>
                  <span>Grand Total:</span> <br>
                  <b class="tm_f18 tm_accent_color">৳ {{$invoice->total_amount}}</b>
                </div>
              </div>
            </div>
          </div>
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      <th class="tm_width_1 tm_semi_bold tm_primary_color">Price</th>
                    </tr>
                  </thead>
                  <tbody>
                ...
                <table class="tm_mb15">
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_bold">৳ {{$total}}</td>
                    </tr>
                    <tr>
                        <td class="tm_width_3 tm_primary_color tm_border_none tm_pt0">Advance</td>
                        <td class="tm_width_3 tm_primary_color tm_text_right tm_border_none tm_pt0"> - ৳ {{$paid}}</td>
                    </tr>
                    @if ($status == 'due')
                        <tr>
                            <td class="tm_width_3 tm_danger_color tm_border_none tm_pt0">Due</td>
                            <td class="tm_width_3 tm_danger_color tm_text_right tm_border_none tm_pt0">+৳ {{$invoice->due_amount}}</td>
                        </tr>
                    ...
                    <tr>
                      ...
                      <td class="tm_width_3 tm_border_top_0 tm_bold tm_f18 tm_primary_color tm_text_right tm_white_color tm_accent_bg tm_radius_0_6_6_0">৳ {{$invoice->total_amount}}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="tm_invoice_footer tm_type1">
              ...
              <div class="tm_right_footer">
                <div class="tm_sign tm_text_center">
                  ...
                  <div class="tm_mb10 tm_m0_md"></div>
                  <p class="tm_m0 tm_ternary_color">Mohiuddin Mahim</p>
                  <p class="tm_m0 tm_f16 tm_primary_color">Chief Finance Officer</p>
                </div>
              </div>
            </div>
          </div>
          <div class="tm_bottom_invoice">
            <div class="tm_bottom_invoice_left">
              <p class="tm_m0 tm_f18 tm_accent_color tm_mb5">Thank you for your visit.</p>
            ...
            <div class="tm_bottom_invoice_right tm_mobile_hide">
              <div class="tm_logo"><img src="{{asset('assets/print/img/logo.png')}}" alt="Let's Go China"></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <script src="{{ asset('assets/print/js/jspdf.min.js')}}"></script>
  <script src="{{ asset('assets/print/js/html2canvas.min.js')}}"></script>
  <script src="{{ asset('assets/print/js/main.js')}}"></script>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'9cb28699eba25f69',t:'MTc3MDYzMTI4OQ=='};var a=document.createElement('script');a.src='../cdn-cgi/challenge-platform/h/b/scripts/jsd/d251aa49a8a3/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
</html>