                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="file" wire:model="file" name="file" /> <br>
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <textarea wire:model="description" name="description" cols="2" rows="2" class="form-control form-control-solid"></textarea>
                                    @error('description') <span class="text-danger">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
                                    <label class="fs-6 fw-semibold mb-2">Number</label>
                                    <input type="text" wire:model="number" name="number" class="form-control form-control-solid" placeholder="Enter Number" />
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <div class="scroll-y me-n7 pe-7">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <input type="file" wire:model="newfile" name="newfile"/> <br>
