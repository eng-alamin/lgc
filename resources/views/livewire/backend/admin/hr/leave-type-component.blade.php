        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">Add Type</button>
                </div>
            </div>
        </div>
            ...
            <table class="table align-middle table-row-dashed fs-6 gy-5" id="datatable">
                <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        ...
                        <th class="min-w-125px">Days Allowed</th>
                ...
                <form wire:submit="store" class="form">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="scroll-y me-n7 pe-7">
                            ...
                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-semibold mb-2">Days Allowed</label>
                                <input type="number" wire:model="days_allowed" class="form-control form-control-solid" placeholder="Days Allowed">
                                @error('days_allowed') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                        </div>
                    </div>
