@section('page-title') Leaves  @endsection
@section('breadcrumb')
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">Add Leave</button>
                </div>
            </div>
        </div>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                <div class="menu-item px-3">
                                 ...
                                 @if ($item->status == 'pending')
                                    <div class="menu-item px-3">
                                        <a href="javascript:;" wire:click="toggleStatus({{ $item->id}}, 'approved')" class="menu-link px-3">Approved</a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="javascript:;" wire:click="toggleStatus({{ $item->id}}, 'rejected')" class="menu-link px-3">Rejected</a>
                                    </div>
                                @endif
                                <div class="menu-item px-3">
                ...
                <form wire:submit="store" class="form" action="#">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="scroll-y me-n7 pe-7">
                            ...
                            <div class="fv-row mb-7">
                                <div wire:ignore>
                                    <label class="required fs-6 fw-semibold mb-2">Select Leave Type</label>
                                    <select class="form-select form-select-solid leave_type_id" data-control="select2" data-placeholder="Select Leave Type" wire:model="leave_type_id">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="date" wire:model="start_date" class="form-control form-control-solid">
                                @error('start_date') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-semibold mb-2">End Date</label>
                                <input type="date" wire:model="end_date" class="form-control form-control-solid">
                                @error('end_date') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-semibold mb-2">Reason</label>
                                <input type="text" wire:model="reason" class="form-control form-control-solid" placeholder="Reason (optional)">
                ...
                <form wire:submit="update" class="form" action="#">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="scroll-y me-n7 pe-7">
                            ...
                            <div class="fv-row mb-7">
                                <label class="required fs-6 fw-semibold mb-2">Enu Date</label>
                                <input type="date" wire:model="end_date" class="form-control form-control-solid">
                                @error('end_date') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>
                            <div class="fv-row mb-7">
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            ...
            Livewire.on('refreshSelect', () => {
                setTimeout(() => {
                    $('.leave_type_id').val(@this.get('leave_type_id')).trigger('change');
