...
<div id="kt_app_content_container" class="app-container container-fluid">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card mb-2">
                <div class="card-body">
                    <form role="form" method="POST" action="{{ route('writer.section.footer.update', $section->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                        <div class="row p-2">
                            <div class="col-md-12">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <div class="input-group date" >
                                        <input type="text" name="description" value="{{$section->description}}" class="form-control form-control-solid" />
                                    </div>
                                    @error('description') <span class="form-text text-danger pt-2 pr-4">{{ $message }}</span> @enderror
                                </div>
                                <div class="fv-row mb-7">
