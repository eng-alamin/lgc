...
@section('breadcrumb-name-two') Setting @endsection
    ...
    <div id="kt_app_content" class="app-content  flex-column-fluid ">
        <div id="kt_app_content_container" class="app-container  container-xxl ">
            @include('livewire.backend.writer.account.navbar')
            <div class="card mb-5 mb-xl-10">
                ...
                <div id="kt_account_settings_profile_details" class="collapse show">
                    <form role="form" method="POST" action="{{ route('writer.account.setting.update', auth()->user()->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                ...
                <div class="card-body border-top p-9">
                    ...
                    @if (!$data->password)
                        <div class="d-flex flex-wrap align-items-center mb-10">
                            <div class="flex-row-fluid">
                                <form method="POST" action="{{ route('writer.account.setting.password.store') }}" class="form" novalidate="novalidate">
                                    @csrf
                                    @method('PUT')
                                        <div class="row mb-1">
                                            <div class="col-lg-4">
                    ...
                    @if($data->id > 1)
                        <div class="d-flex flex-wrap align-items-center">
                            ...
                            <div id="kt_signin_email_edit" class="flex-row-fluid d-none">
                                <form class="form" method="POST" action="{{ route('writer.account.setting.email.update') }}" novalidate="novalidate">
                                    @csrf
                                    @method('PUT')
                    ...
                    <div class="d-flex flex-wrap align-items-center mb-10">
                        ...
                        <div id="kt_signin_password_edit" class="flex-row-fluid d-none">
                            <form method="POST" action="{{ route('writer.account.setting.password.update') }}" class="form" novalidate="novalidate">
                                @csrf
                                @method('PUT')
                                    <div class="row mb-1">
                                        <div class="col-lg-4">
            ...
            @if($data->id > 1)
                <div class="card">
                    ...
                    <div id="kt_account_settings_deactivate" class="collapse show">
                            <form method="POST" action="{{ route('writer.account.setting.deactivate') }}" class="form">
                                @csrf
                                {{-- @method('PUT') --}}
                                <div class="card-body border-top p-9">
