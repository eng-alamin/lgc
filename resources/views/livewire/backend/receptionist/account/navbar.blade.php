    ...
    <div class="card-body pt-9 pb-0">
        ...
        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold">
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('receptionist.account.overview') == true ? 'active' : '' }}" href="{{route('receptionist.account.overview')}}"> Overview </a>
            </li>
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('receptionist.account.setting') == true ? 'active' : '' }}" href="{{route('receptionist.account.setting')}}"> Settings </a>
            </li>
            <li class="nav-item mt-2">
                <a class="nav-link text-active-primary ms-0 me-10 py-5 {{ Route::is('receptionist.account.activity') == true ? 'active' : '' }}" href="{{route('receptionist.account.activity')}}"> Activity </a>
            </li>
        </ul>
