    ...
    <div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
        ...
        <div class="col-md-6 col-lg-6 col-xl-6 col-xxl-3 mb-md-5 mb-xl-10">
            ...
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #e2771c; background-image:url('{{asset("assets/backend/media/patterns/vector-1.png")}}')">
                ...
                <div class="card-body d-flex flex-column align-items-center pt-0">
                    <div>
                        <span class="fs-2hx fw-bold text-white me-2">{{$appointmentsToday}}</span>
                    </div>
                    <div class="fw-bold fs-6 text-white opacity-75">
            ...
            <div class="card card-flush bgi-no-repeat bgi-size-contain bgi-position-x-end h-md-50 mb-5 mb-xl-10" style="background-color: #F1416C;background-image:url('{{asset("assets/backend/media/patterns/vector-1.png")}}')">
                ...
                <div class="card-body d-flex flex-column align-items-center pt-0">
                    <div>
                        <span class="fs-2hx fw-bold text-white me-2">{{$callLogsToday }}</span>
                    </div>
                    <div class="fw-bold fs-6 text-white opacity-75">
                        <span>Call Logs Today  </span>
                    </div>
                </div>
                <!--end::Card body-->
            </div>
            ...
            <div class="card bg-danger">
                ...
                <div class="card-body p-0 position-relative overflow-hidden">
                    <div class="row justify-content-center py-5 my-5">
                        ...
                        <div class="col-10 col-md-5 bg-light px-6 py-8 rounded my-3 mx-5 d-flex justify-content-between align-items-center">
                            <div class="d-flex flex-column text-center">
                                <i class="ki-duotone ki-address-book fs-4x text-primary">
                                    <span class="path1"></span>
                                    <span class="path2"></span>
                                    <span class="path3"></span>
                                </i>
                                <a href="#" class="text-primary fs-4 fw-bold">Total Appointment</a>
                                <span class="badge badge-light-primary">Completed</span>
                            </div>
                            <div class="">
                                <span class="text-primary fs-3 fw-bold">{{ $total_appointment }}</span>
                            </div>
                        </div>
                        <div class="col-10 col-md-5 bg-light px-6 py-8 rounded my-3 mx-5 d-flex justify-content-between align-items-center">
                            <div class="d-flex flex-column text-center">
                                ...
                                <a href="#" class="text-danger fs-4 fw-bold">Total Follow Up</a>
                        ...
                        <div class="col-10 col-md-5 bg-light px-6 py-8 rounded my-3 mx-5 d-flex justify-content-between align-items-center">
                            <div class="d-flex flex-column text-center">
                                ...
                                <a href="#" class="text-warning fs-4 fw-bold">Total Call Log</a>
    ...
    <div class="row gx-5 gx-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                <div class="card-header pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-dark">Appointments</span>
                        <span class="text-gray-400 mt-1 fw-semibold fs-6">{{ucfirst($appointmentFilter)}} {{$this->appointments->count()}} Data</span>
                    </h3>
                    <div class="card-toolbar">
                        <ul class="nav" id="kt_chart_widget_8_tabs">
                            <li class="nav-item">
                                <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 {{ $appointmentFilter == 'today' ? 'active' : '' }}"  wire:click="setFilterAppointment('today')">Today</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 {{ $appointmentFilter == 'yesterday' ? 'active' : '' }}"  wire:click="setFilterAppointment('yesterday')">Yesterday</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 {{ $appointmentFilter == 'week' ? 'active' : '' }}"  wire:click="setFilterAppointment('week')">Week</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="card-body pt-6">
                    <div class="m-0">
                        ...
                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                            <div class="me-5">
                                <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">{{ucfirst($item->type)}}</a>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">{{$item->client?->name ?? 'N/L'}} - {{$item->client?->phone ?? 'N/L'}}</span>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">{{$item->appointment_date}}</span>
                            </div>
                            <div class="d-flex flex-column align-items-center"> 
                                <a href="#" target="_blank" class="menu-link m-0">
                                    <span class="badge badge-light-primary fs-base">{{ucfirst($item->status)}}</span>
                                </a>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">{{ \Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</span>
                            </div>
                        </div>
        ...
        <div class="col-xxl-6 mb-5 mb-xl-10">
            <div class="card card-flush h-xl-100">
                <div class="card-header pt-5">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bold text-dark">Call Logs</span>
                        <span class="text-gray-400 mt-1 fw-semibold fs-6">{{ucfirst($calllogFilter)}} {{$this->calllogs->count()}} Data</span>
                    </h3>
                    <div class="card-toolbar">
                        <ul class="nav" id="kt_chart_widget_8_tabs">
                            <li class="nav-item">
                                <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 {{ $calllogFilter == 'today' ? 'active' : '' }}"  wire:click="setFilterCalllog('today')">Today</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 {{ $calllogFilter == 'yesterday' ? 'active' : '' }}"  wire:click="setFilterCalllog('yesterday')">Yesterday</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link btn btn-sm btn-color-muted btn-active btn-active-light fw-bold px-4 me-1 {{ $calllogFilter == 'week' ? 'active' : '' }}"  wire:click="setFilterCalllog('week')">Week</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="card-body pt-6">
                    <div class="m-0">
                        @foreach ($this->calllogs as $item)
                        <div class="d-flex flex-stack flex-row-fluid d-grid gap-2">
                            <div class="me-5">
                                <a href="#" class="text-gray-800 fw-bold text-hover-primary fs-6">{{ucfirst($item->type)}}</a>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">{{$item->name}} - {{$item->phone ?? 'N/L'}}</span>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">{{$item->follow_up_date}}</span>
                            </div>
                            <div class="d-flex flex-column align-items-center"> 
                                <span class="badge badge-light-primary fs-base">{{ucfirst($item->status)}}</span>
                                <span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">{{ \Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</span>
