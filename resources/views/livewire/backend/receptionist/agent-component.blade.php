...
<div id="kt_app_content_container" class="app-container container-fluid">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addAgent">Add Agent</button>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                ...
                                @endif
                                <div class="menu-item px-3">
                                    <a href="javascript:;" wire:click="edit({{ $item->id }})" data-bs-toggle="modal" data-bs-target="#editAgent" class="menu-link px-3">Edit</a>
                                </div>
                                <div class="menu-item px-3">
    ...
    <!--begin::Modals-->
    <div wire:ignore.self class="modal fade" id="addAgent" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="scroll-y me-n7 pe-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" wire:model="website" name="website" class="form-control form-control-solid" placeholder="Enter Website" />
     ...
     <!--end::Modals-->
    <!--begin::Modals-->
    <div wire:ignore.self class="modal fade" id="editAgent" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
