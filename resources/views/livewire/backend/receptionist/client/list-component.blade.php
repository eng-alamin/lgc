        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal" data-bs-target="#addModal">Add Client</button>
                </div>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center border-0">
                            ...
                            <div class="d-flex flex-column">
                                <div>
                                    <a href="{{route('receptionist.client.overview', $item->id)}}" target="_blank" class="text-gray-800 text-hover-primary mb-1">{{$item->user->name}}</a>
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="scroll-y me-n7 pe-7">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select wire:ignore class="form-select p-0 w-100 border-0 selectpicker" wire:model="service" title="Select a service">
                            ...
                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-semibold mb-2">Select Counselor</label>
                                <select wire:ignore class="form-select p-0 w-100 border-0 selectpicker" data-live-search="true" wire:model="counselor_id" title="Select a counselor">
                            ...
                            <div class="fv-row mb-7">
                                <label class="fs-6 fw-semibold mb-2">Select Agent</label>
                                <select wire:ignore class="form-select p-0 w-100 border-0 selectpicker" data-live-search="true" wire:model="agent_id" title="Select a agent">
