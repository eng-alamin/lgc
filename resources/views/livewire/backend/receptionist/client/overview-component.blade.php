<div id="kt_app_content_container" class="app-container container-fluid">
    <div class="row g-5 g-xl-8">
        ...
        @include('livewire.backend.receptionist.client.navbar')
                        ...
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h3 class="fw-bold m-0 text-gray-800">Progress Compleation<br>
                                <div class="d-flex align-items-center mt-1 fs-6">
                                    <div class="text-muted me-2 fs-7">{{ \Carbon\Carbon::parse($this->form?->client->user->created_at)->format('M d Y - h:i A') }}</div>
                                </div>    
                            </h3>
                        </div>
                                                    ...
                                                    <div class="d-flex align-items-center mt-1 fs-6">
                                                        @if($item->form?->agent)
                                                            @if($item->form?->counselor->user->avatar)
                                                                ...
                                                                <div class="symbol symbol-circle symbol-25px" data-bs-toggle="tooltip" data-bs-boundary="window" data-bs-placement="top" title="{{$item->form?->agent->name}}">
                                                ...
                                                <div class="overflow-auto pb-5">
                                                    @foreach ($item->form->invoices as $inv)
                                                        <div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-750px px-7 py-3 mb-5">
                                                            ...
                                                            <div class="min-w-125px pe-2">
                                                                @if ($inv->status == 'paid')
                                                                    <span class="badge badge-light-success">{{ucfirst(str_replace('_', ' ', $inv->status))}}</span>
                                                                @elseif ($inv->status == 'partial')
                                                                    <span class="badge badge-light-primary">{{ucfirst(str_replace('_', ' ', $inv->status))}}</span>
                                                                @else
                                                                    <span class="badge badge-light-danger">{{ucfirst(str_replace('_', ' ', $inv->status))}}</span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    @endforeach
                        ...
                        <div class="scroll-y me-n7 pe-7">
                            <div class="fv-row mb-7">
                                <div wire:ignore>
                                    ...
                                    <select class="form-select form-select-solid stage_id" data-control="select2" data-hide-search="true" data-placeholder="Select a stage" wire:model.live="stage_id">
                            ...
                            @if ($this->stage_id == 1)
                                <div class="fv-row mb-7">
                                    <div wire:ignore>
                                        ...
                                        <select class="form-select form-select-solid counselor_id" data-control="select2" data-hide-search="true" data-placeholder="Select a Counselor" wire:model="counselor_id">
                                ...
                                <div class="fv-row mb-7">
                                    <div wire:ignore>
                                        ...
                                        <select class="form-select form-select-solid agent_id" data-control="select2" data-hide-search="true" data-placeholder="Select a Agent" wire:model="agent_id">
                            ...
                            <div class="fv-row mb-7">
                                <div wire:ignore>
                                    ...
                                    <select class="form-select form-select-solid status" data-control="select2" data-hide-search="true" data-placeholder="Select a status" wire:model="status">
                ...
                <div class="modal-body py-10 px-lg-17">
                    <div class="scroll-y me-n7 pe-7">
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-7">
                                <label class="fs-6 fw-semibold mb-2">Agent :</label>
                                <div>{{ $this->invoice?->agent->name ?? 'N/A' }}</div>
                            </div>
                            <div class="col-md-4 mb-7">
                            ...
                            <div class="col-md-4 mb-7">
                                ...
                                <div>{{ ucfirst($this->invoice?->status) ?? 'N/A' }}</div>
                            </div>
                            <div class="col-md-4 mb-7">
    ...
    <script>
        document.addEventListener('livewire:init', () => {
            $('.stage_id').on('change', function () {
                @this.set('stage_id', $(this).val());
            });
            $('.counselor_id').on('change', function () {
                @this.set('counselor_id', $(this).val());
            });
            ...
            Livewire.on('refreshSelect', () => {
                setTimeout(() => {
                    ...
                    $('.counselor_id').val(@this.get('counselor_id')).trigger('change');
                    $('.agent_id').val(@this.get('agent_id')).trigger('change');
