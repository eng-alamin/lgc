                    ...
                    <div class="d-flex flex-wrap flex-stack">
                        ...
                        <div class="d-flex align-items-center w-200px w-sm-300px flex-column mt-3">
                            <div class="d-flex justify-content-between w-100 mt-auto mb-2">
                                ...
                                <span class="fw-bold fs-6">{{ $this->form->client?->profile_completion ?? 0 }}%</span>
                            </div>
                            <div class="h-5px mx-3 w-100 bg-light mb-3">
                                <div class="bg-success rounded h-5px" role="progressbar" style="width: {{ $this->form->client?->profile_completion ?? 0 }}%;" aria-valuenow="{{ $this->form->completedStage?->stage?->progress_percent ?? 0 }}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                        </div>
                        <!--end::Progress-->
                    </div>
