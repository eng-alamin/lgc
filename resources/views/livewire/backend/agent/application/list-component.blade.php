@section('page-title') Registration Forms @endsection
@section('breadcrumb')
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                <div class="d-flex justify-content-end">
                    <a href="{{route('agent.application.add')}}" target="_blank" class="btn btn-sm btn-primary">New Form</a>
                </div>
            </div>
        </div>
                            ...
                            <td class="text-end">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4 dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                    <div class="menu-item px-3">
                                        <a href="{{route('agent.application.edit', $item->id)}}" target="_blank" class="menu-link px-3">Edit</a>
                                    </div>
                                    <div class="menu-item px-3">
                                        <a href="{{route('agent.application.view', $item->id)}}" target="_blank" class="menu-link px-3">View</a>
                                    </div>
                                    <div class="menu-item px-3">
