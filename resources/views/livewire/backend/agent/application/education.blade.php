<form class="form" wire:submit.prevent="education">
    <div class="row justify-content-evenly p-2">
        <div class="col-md-12 d-flex align-items-center flex-column text-center pb-5 mb-5">
            <h1>Application For Education {{$track_number ?? ''}}</h1>
        ...
        <div class="col-md-5">
            ...
            <div class="fv-row mb-7">
                ...
                <input type="date" wire:model="e_place_of_issue" class="form-control form-control-solid" />
                @error('e_place_of_issue') <span class="text-danger">{{ $message }}</span> @enderror
            </div>
        </div>
        <div class="col-md-5">
            ...
            <div class="fv-row mb-7">
                ...
                <div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" wire:model="e_medium_of_instruction" id="English" value="English">
                        <label class="form-check-label" for="English">English</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" wire:model="e_medium_of_instruction" id="Bangla" value="Bangla">
                        <label class="form-check-label" for="Bangla">Bangla</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" wire:model="e_medium_of_instruction" id="Other" value="Other">
