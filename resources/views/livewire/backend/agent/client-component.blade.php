                    ...
                    <tr>
                        ...
                        <td class="d-flex align-items-center border-0">
                            <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                <a href="{{route('agent.client.overview', $item->id)}}" target="_blank">
                                    @if($item->user->avatar)
                            ...
                            <div class="d-flex flex-column">
                                <div>
                                    <a href="{{route('agent.client.overview', $item->id)}}" target="_blank" class="text-gray-800 text-hover-primary mb-1">{{$item->user->name}}</a>
