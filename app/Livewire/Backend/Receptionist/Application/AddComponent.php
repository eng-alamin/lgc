...
class AddComponent extends Component
{
    ...
    {
        return view('livewire.backend.receptionist.application.add-component')
    ...
    public function education()
    {
        ...
        try{
            ...
            return redirect()->route('receptionist.application.list')->with('success', 'Form request submitted successfully!');
        }catch(\Exception $e){
