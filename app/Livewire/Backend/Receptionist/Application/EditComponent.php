...
class EditComponent extends Component
{
    ...
    {
        return view('livewire.backend.receptionist.application.edit-component')
    ...
    public function education()
    {
        ...
        try{
            ...
            return redirect()->route('receptionist.application.edit', $data->id)->with('success', 'Form request updated successfully!');
        }catch(\Exception $e){
