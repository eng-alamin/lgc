...
class Setting extends Component
{
    public function render()
    {
        ...
        return view('livewire.backend.receptionist.account.setting', [
            'data' => $data,
        ])
    ...
    public function updateSetting(Request $request, string $id)
    {
        ...
        try{
            ...
            return redirect()->route('receptionist.account.setting')->with('success', 'Account updated successfully');
    ...
    public function updateEmail(Request $request)
    {
        ...
        if (Hash::check($request->password, $data->password)) {
            ...
            return redirect()->route('receptionist.account.setting')->with('success', 'Email updated successfully.');
        }

        return redirect()->route('receptionist.account.setting')->with('error', 'Incorrect password.');
    }
    ...
    public function updatePassword(Request $request)
    {
        ...
        if (Hash::check($request->current_password, $data->password)) {
            ...
            return redirect()->route('receptionist.account.setting')->with('success', 'Password updated successfully.');
        }
