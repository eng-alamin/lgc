...
class DocumentComponent extends Component
{
    ...
    {    
       ...
       $clients = User::where('type', 'client')->get();
        ...
        return view('livewire.backend.receptionist.document-component', [
            'documents' => $documents,
            'clients' => $clients,
        ])
    ...
    public function store()
    {
        ...
        try{
            ...
            return redirect()->route('receptionist.documents')->with('success', 'Data is successfully saved');
        }catch(\Exception $e){
    ...
    public function update()
    {
        try {
            ...
            return redirect()->route('receptionist.documents')->with('success', 'Data successfully updated');
    ...
    public function verify($id)
    {
        ...
        return redirect()->route('receptionist.documents')->with('success', 'Data successfully verified');
    }
}
