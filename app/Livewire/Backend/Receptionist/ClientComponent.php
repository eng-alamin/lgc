...
class ClientComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.backend.receptionist.client-component', [
            'data' => $data,
        ])
    ...
    public function store()
    {
        ...
        try{
            ...
            return redirect()->route('receptionist.clients')->with('success', 'Consignee is successfully saved');
        }catch(\Exception $e){
    ...
    public function update()
    {
        ...
        try{
            ...
            return redirect()->route('receptionist.clients')->with('success', 'Consignee is successfully updated');
        }catch(\Exception $e){
            return redirect()->back()->with('error', 'Consignee updated failed: ' . $e->getMessage());
        }
    }
    ...
    public function statusClick($id, $status)
    {
        try{
            ...
            return redirect()->route('receptionist.clients')->with('success', 'Client is successfully status!');
        }catch(\Exception $e){
    ...
    public function deleteClient()
    {
        try{
            ...
            return redirect()->route('receptionist.clients')->with('success', 'Consignee is successfully deleted');
        }catch(\Exception $e){
    ...
    public function approved($id)
    {
        try{
            ...
            return redirect()->route('receptionist.clients')->with('success', 'Consignee is successfully approved');
        }catch(\Exception $e){
