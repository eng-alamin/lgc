...
class EditComponent extends Component
{
    ...
    {
        return view('livewire.backend.agent.application.edit-component')
    ...
    public function education()
    {
        ...
        try{
            ...
            return redirect()->route('agent.application.edit', $data->id)->with('success', 'Form request updated successfully!');
        }catch(\Exception $e){
