...
class InvoiceComponent extends Component
{
    ...
    public function store()
    {
        ...
        try{
            ...
            return redirect()->route('agent.invoices')->with('success', 'Data Created Successfully.');
        }catch(\Exception $e){
    ...
    public function update()
    {
        ...
        try {
            ...
            return redirect()->route('agent.invoices')->with('success', 'Data successfully updated');
    ...
    public function deleteInvoice()
    {
        try{
            ...
            return redirect()->route('agent.invoices')->with('success', 'Consignee is successfully deleted');
        }catch(\Exception $e){
