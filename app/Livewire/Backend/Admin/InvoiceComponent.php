...
class InvoiceComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.backend.admin.invoice-component', [
            'invoices' => $invoices,
            'forms' => $forms,
        ])
    ...
    public function store()
    {
        ...
        try{
            ...
            return redirect()->route('admin.invoices')->with('success', 'Data Created Successfully.');
        }catch(\Exception $e){
    ...
    public function update()
    {
        ...
        try {
            ...
            return redirect()->route('admin.invoices')->with('success', 'Data successfully updated');
    ...
    public function deleteInvoice()
    {
        try{
            ...
            return redirect()->route('admin.invoices')->with('success', 'Consignee is successfully deleted');
        }catch(\Exception $e){
    ...
    public function statusClick($id, $newStatus)
    {
        ...
        return redirect()->route('admin.invoices')->with('success', 'Invoices is successfully status!');
    }
