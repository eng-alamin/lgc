...
class FollowUpComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.backend.admin.follow-up-component',[
    ...
    public function markDone($id)
    {
        ...
        if($follow){
            $follow->status = 'done';
            $follow->save();
           return redirect()->route('admin.followups')->with('success', 'Consignee is successfully marked');
        }
    }
    ...
    public function store()
    {
        ...
        return redirect()->route('admin.followups')->with('success', 'Data Created Successfully.');
    }
    ...
    public function deleteFollowup()
    {
        try{
            ...
            return redirect()->route('admin.followups')->with('success', 'Consignee is successfully deleted');
        }catch(\Exception $e){
