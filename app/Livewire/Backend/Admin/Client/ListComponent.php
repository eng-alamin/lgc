...
class ListComponent extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.backend.admin.client.list-component', [
            'clients' => $clients,
    ...
    public function store()
    {
        ...
        try{
            ...
            return redirect()->route('admin.client.list')->with('success', 'Consignee is successfully saved');
        }catch(\Exception $e){
    ...
    public function update()
    {
        ...
        try{
            ...
            return redirect()->route('admin.client.list')->with('success', 'Consignee is successfully updated');
        }catch(\Exception $e){
            return redirect()->back()->with('error', 'Consignee updated failed: ' . $e->getMessage());
        }
    }
    ...
    public function deleteClient()
    {
        try{
            ...
            return redirect()->route('admin.client.list')->with('success', 'Consignee is successfully deleted');
        }catch(\Exception $e){
    ...
    public function statusClick($id, $status)
    {
        try{
            ...
            return redirect()->route('admin.client.list')->with('success', 'Client is successfully status!');
        }catch(\Exception $e){
