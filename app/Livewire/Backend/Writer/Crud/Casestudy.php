...
class Casestudy extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.backend.writer.crud.casestudy', [
            'data' => $data,
        ])
    ...
    public function store()
    {
        ...
        try{
            ...
            return redirect()->route('writer.crud.casestudies')->with('success', 'Data is successfully saved');
        }catch(\Exception $e){
    ...
    public function update()
    {
        ...
        try {
            ...
            return redirect()->route('writer.crud.casestudies')->with('success', 'Data successfully updated');
    ...
    public function delete()
    {
        try {
            ...
            return redirect()->route('writer.crud.casestudies')->with('success', 'Data successfully deleted');
    ...
    public function deleteSelectedItems()
    {
        ...
        try {
            ...
            return redirect()->route('writer.crud.casestudies')->with('success', 'Selected data successfully deleted');
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'Data deletion failed: ' . $e->getMessage());
        }
    }
