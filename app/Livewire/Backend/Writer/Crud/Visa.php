...
namespace App\Livewire\Backend\Writer\Crud;
...
class Visa extends Component
{
    ...
    {    $visas = VisaModel::get();
        ...
        return view('livewire.backend.writer.crud.visa', [
            'visas' => $visas,
        ])
    ...
    public function store()
    {
        ...
        try{
            ...
            if($this->file) {
                ...
                $path = $this->file->storeAs('visas', $fileName, 'public');
            ...
            return redirect()->route('writer.crud.visa')->with('success', 'Data is successfully saved');
        }catch(\Exception $e){
    ...
    public function update()
    {
        ...
        try {
            $update = VisaModel::findOrFail($this->visa_id);
            ...
            if ($this->newfile) {
                ...
                $path = $this->newfile->storeAs('visas', $fileName, 'public');
            ...
            return redirect()->route('writer.crud.visa')->with('success', 'Data successfully updated');
    ...
    public function delete()
    {
        try {
            ...
            return redirect()->route('writer.crud.visa')->with('success', 'Data successfully deleted');
    ...
    public function deleteSelectedItems()
    {
        ...
        try {
            ...
            return redirect()->route('writer.crud.visa')->with('success', 'Selected data successfully deleted');
        } catch (\Exception $e) {
            return redirect()->back()->with('error', 'Data deletion failed: ' . $e->getMessage());
        }
    }
